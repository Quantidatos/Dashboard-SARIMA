...
dash.register_page(__name__, name='3-Selección del modelo', title='SARIMA | 3-Model Selection')
...
layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            html.H3(['Determinación de Hiperparametros']),
            html.P([html.B(['SARIMA(p,d,q)(P,D,Q)m'])], className='par')
        ], width=12, className='row-titles')
    ]),
    # train-test split
    dbc.Row([
        dbc.Col([], width = 2),
        dbc.Col([html.P(['Elegir el porcentaje de los ',html.B(['datos de entrenamiento']),': '], className='par')], width = 4),
        dbc.Col([
            html.Div([
    ...
    dbc.Row([
        dbc.Col([
            html.Div([
                dbc.Row([
                    dbc.Col([], width = 1),
                    dbc.Col([html.P(['Establecer el rango de parámetros ',html.B(['p, d, q']),' (desde, hasta)'], className='par')], width = 10),
                    dbc.Col([], width = 1),
                ]),
                dbc.Row([
                    dbc.Col([html.P([html.B(['p']),':'], className='par')], width=2),
                    dbc.Col([dcc.Dropdown(options=[], value='0', placeholder='desde', clearable=False, searchable=True, persistence=True, persistence_type='memory', id='p-from')], width=4),
                    dbc.Col([], width=1),
                    dbc.Col([dcc.Dropdown(options=[], value='0', placeholder='hasta', clearable=False, searchable=True, persistence=True, persistence_type='memory', id='p-to')], width=4),
                    dbc.Col([], width=1)
                ]),
                dbc.Row([
                    dbc.Col([html.P([html.B(['d']),':'], className='par')], width=2),
                    dbc.Col([dcc.Dropdown(options=[], value='0', placeholder='desde', clearable=False, searchable=True, persistence=True, persistence_type='memory', id='d-from')], width=4),
                    dbc.Col([], width=1),
                    dbc.Col([dcc.Dropdown(options=[], value='0', placeholder='hasta', clearable=False, searchable=True, persistence=True, persistence_type='memory', id='d-to')], width=4),
                    dbc.Col([], width=1)
                ]),
                dbc.Row([
                    dbc.Col([html.P([html.B(['q']),':'], className='par')], width=2),
                    dbc.Col([dcc.Dropdown(options=[], value='0', placeholder='desde', clearable=False, searchable=True, persistence=True, persistence_type='memory', id='q-from')], width=4),
                    dbc.Col([], width=1),
                    dbc.Col([dcc.Dropdown(options=[], value='0', placeholder='hasta', clearable=False, searchable=True, persistence=True, persistence_type='memory', id='q-to')], width=4),
                    dbc.Col([], width=1)
                ])                
        ...
        dbc.Col([
            html.Div([
                dbc.Row([
                    dbc.Col([], width = 1),
                    dbc.Col([html.P(['Establecer el rango de parámetros estacionales ',html.B(['P, D, Q, m']),' (desde, hasta)'], className='par')], width = 10),
                    dbc.Col([], width = 1),   
                ]),
                dbc.Row([
                    dbc.Col([html.P([html.B(['P']),':'], className='par')], width=2),
                    dbc.Col([dcc.Dropdown(options=[], value='0', placeholder='desde', clearable=False, searchable=True, persistence=True, persistence_type='memory', id='sp-from')], width=4),
                    dbc.Col([], width=1),
                    dbc.Col([dcc.Dropdown(options=[], value='0', placeholder='hasta', clearable=False, searchable=True, persistence=True, persistence_type='memory', id='sp-to')], width=4),
                    dbc.Col([], width=1)
                ]),
                dbc.Row([
                    dbc.Col([html.P([html.B(['D']),':'], className='par')], width=2),
                    dbc.Col([dcc.Dropdown(options=[], value='0', placeholder='desde', clearable=False, searchable=True, persistence=True, persistence_type='memory', id='sd-from')], width=4),
                    dbc.Col([], width=1),
                    dbc.Col([dcc.Dropdown(options=[], value='0', placeholder='hasta', clearable=False, searchable=True, persistence=True, persistence_type='memory', id='sd-to')], width=4),
                    dbc.Col([], width=1)
                ]),
                dbc.Row([
                    dbc.Col([html.P([html.B(['Q']),':'], className='par')], width=2),
                    dbc.Col([dcc.Dropdown(options=[], value='0', placeholder='desde', clearable=False, searchable=True, persistence=True, persistence_type='memory', id='sq-from')], width=4),
                    dbc.Col([], width=1),
                    dbc.Col([dcc.Dropdown(options=[], value='0', placeholder='hasta', clearable=False, searchable=True, persistence=True, persistence_type='memory', id='sq-to')], width=4),
                    dbc.Col([], width=1)
                ]),
                dbc.Row([
                    dbc.Col([html.P([html.B(['m']),':'], className='par')], width=2),
                    dbc.Col([dcc.Dropdown(options=[], value='0', placeholder='desde', clearable=False, searchable=True, persistence=True, persistence_type='memory', id='sm-from')], width=4),
                    dbc.Col([], width=1),
                    dbc.Col([dcc.Dropdown(options=[], value='0', placeholder='hasta', clearable=False, searchable=True, persistence=True, persistence_type='memory', id='sm-to')], width=4),
                    dbc.Col([], width=1)
                ])
            ], className = 'div-hyperpar')
        ], width = 6, className = 'col-hyperpar')
    ...
    dbc.Row([
        dbc.Col([], width=3),
        dbc.Col([
            html.P(['Combinaciones posibles: ', html.B([], id='comb-nr')], className='par')
        ], width=3),
        dbc.Col([
            html.Button('Buscar modelos', id='start-gs', n_clicks=0, title='La búsqueda de modelos puede demorar algunos minutos', className='my-button')
...
def grid_search_results(_trainp, _nclicks, p_from,p_to,d_from,d_to,q_from,q_to,sp_from,sp_to,sd_from,sd_to,sq_from,sq_to,sm_from,sm_to,_memo):
    ...
    if int(_nclicks) > 0 and _datatrain is not None and _datatest is not None:
        ...
        _gs_res_tbl.columns = ['Parámetros (p,d,q)(P,D,Q)m', 'AIC Score']
    ...
    if 'grid_search_results' in _memo.keys():
        ...
        title_ = html.P([html.B(['Mejores 10 modelos según criterio AIC'])], className='par')
